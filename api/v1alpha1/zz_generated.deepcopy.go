...
func (in *EnvVarCfg) DeepCopyInto(out *EnvVarCfg) {
	*out = *in
	if in.ValueFrom != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnvVarCfg.
func (in *EnvVarCfg) DeepCopy() *EnvVarCfg {
	if in == nil {
		return nil
	}
	out := new(EnvVarCfg)
...
func (in *MCPServerDeployment) DeepCopyInto(out *MCPServerDeployment) {
	*out = *in
	...
	if in.Env != nil {
		...
		*out = make(map[string]EnvVarCfg, len(*in))
