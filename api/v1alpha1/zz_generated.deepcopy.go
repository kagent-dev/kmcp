...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MCPClientAuthentication) DeepCopyInto(out *MCPClientAuthentication) {
	*out = *in
	if in.Provider != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MCPClientAuthentication.
func (in *MCPClientAuthentication) DeepCopy() *MCPClientAuthentication {
	if in == nil {
		return nil
	}
	out := new(MCPClientAuthentication)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MCPServerAuthorization) DeepCopyInto(out *MCPServerAuthorization) {
	*out = *in
	if in.CEL != nil {
		...
		*out = new(MCPServerCELAuthorization)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MCPServerCELAuthorization) DeepCopyInto(out *MCPServerCELAuthorization) {
	*out = *in
	if in.Rules != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MCPServerCELAuthorization.
func (in *MCPServerCELAuthorization) DeepCopy() *MCPServerCELAuthorization {
	if in == nil {
		return nil
	}
	out := new(MCPServerCELAuthorization)
...
func (in *MCPServerSpec) DeepCopyInto(out *MCPServerSpec) {
	*out = *in
	...
	if in.ClientAuthn != nil {
		in, out := &in.ClientAuthn, &out.ClientAuthn
		*out = new(MCPClientAuthentication)
		(*in).DeepCopyInto(*out)
	}
	if in.PathMatch != nil {
	...
	if in.RouteFilter != nil {
		in, out := &in.RouteFilter, &out.RouteFilter
		*out = new(RouteFilter)
		(*in).DeepCopyInto(*out)
	}
}
